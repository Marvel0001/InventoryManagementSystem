	...
	function optionAction() {
		$(".dropOption").click(function() {
			...
			if (type == "所有") {
				...
				$("#search_input_type").removeAttr("readOnly");
				search_type_storage = "searchByStockOpen";
			}  else if(type = "禁用的仓库") {
				$("#search_input_type").removeAttr("readOnly");
				search_type_storage = "searchByStockClose";
			}  else {
				$("#search_input_type").removeAttr("readOnly");
			}
			...
			<div class="col-md-1  col-sm-2">
				<div class="btn-group">
					...
					<ul class="dropdown-menu" role="menu">
						...
						<li><a href="javascript:void(0)" class="dropOption">货物价值</a></li>
